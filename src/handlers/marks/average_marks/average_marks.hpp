...
class AverageMarks final : public userver::server::handlers::HttpHandlerBase, marks_base::MarksBase {
 public:
  static constexpr std::string_view kName = "handler-average-marks"sv;

  using HttpHandlerBase::HttpHandlerBase;

  AverageMarks(const userver::components::ComponentConfig& config,
